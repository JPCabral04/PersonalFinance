    ...
    <div className="container mx-auto p-4 md:p-6">
      <div className="relative mb-8 flex items-center justify-center">
        <button
          type="button"
          onClick={() => navigate('/')}
          className="absolute left-0 rounded-md p-2 text-gray-600 transition duration-200 hover:text-gray-800 focus:ring-2 focus:ring-gray-300 focus:outline-none"
        ...
        <h1 className="mb-0 text-center text-3xl font-extrabold text-gray-800 md:text-4xl">
          {' '}
          {/* Removido mb-8 do h1 para centralizar melhor */}
          Minhas Contas
        </h1>
      </div>
      ...
      {deleteError && ( // Exibe erro de exclusão
        <div
          className="relative mb-6 rounded border border-red-400 bg-red-100 px-4 py-3 text-sm text-red-700"
          role="alert"
        >
